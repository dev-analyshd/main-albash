...
"[project]/lib/supabase/dev-server.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/dashboard/chat/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$dev$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/dev-server.ts [app-route] (ecmascript)");
...
async function GET(req) {
    ...
    try {
        const dev = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$dev$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createDevClient"])();
        const usersRes = await dev.auth.admin.listUsers({
            perPage: 100
        });
        const users = usersRes?.data?.users || [];
        const filtered = users.filter((u)=>u.last_sign_in_at) // signed-in users only
        .filter((u)=>{
            if (!q) return true;
            const email = u.email || "";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__da4000c8._.js.map