...
export default async function CompanyDashboardPage() {
  ...
  const companyStats = [
    ...
    { title: "Team Members", value: "0", icon: Users, color: "text-blue-600", bgColor: "bg-blue-100" },
    { title: "Active Projects", value: "0", icon: BarChart3, color: "text-purple-600", bgColor: "bg-purple-100" },
    {
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your company profile and enterprise services</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl font-bold">{profile?.full_name || "Company Name"}</h2>
                {isVerified && (
              ...
              <p className="text-muted-foreground mb-4">{profile?.bio || "Enterprise company profile"}</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <CardContent>
            {latestApplication ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-muted-foreground mb-4">Apply for company verification</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Premium services for companies</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { title: "Corporate Website", desc: "Professional multi-page corporate website", icon: Globe },
              { title: "Custom Software", desc: "ERP, CRM, and business automation", icon: BarChart3 },
              { title: "Brand Development", desc: "Complete corporate branding package", icon: Star },
              { title: "Digital Marketing", desc: "SEO, SEM, and performance marketing", icon: Users },
            ].map((service) => (
